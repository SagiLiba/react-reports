...
const BasePageGroup = ({ children, name = '', maxPages = null, repeating = null }) => {
  ...
  const showRepeatingTopComponent = useMemo(() => showRepeatingComponent(repeating, 'top'), [repeating]);
  const showRepeatingBottomComponent = useMemo(() => showRepeatingComponent(repeating, 'bottom'), [repeating]);
